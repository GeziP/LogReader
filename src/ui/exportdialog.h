 ...
 *          operations including format selection, field inclusion, and file
 * path specification. Integrates with the LogExporter system for seamless
 ...
 * @details This dialog provides a comprehensive interface for users to
 * configure log export parameters including target formats, field inclusion
 * settings, and output file paths. It integrates with the AppSettings system to
...
public:
     ...
     *          interface, loads saved settings, and configures signal
     * connections. The dialog is modal by default when a parent is specified.
     */
     ...
     *          export operation. Also updates export hints and file size
     * estimates.
     */
...
private slots:
     ...
     *          based on selected export formats and updates the file path
     * field.
     */
     ...
     *          file path suggestions, format-specific hints, and
     * enabling/disabling related UI elements. Ensures consistent UI state.
     */
     ...
     *          and estimated export statistics. Called whenever settings
     * change.
     */
    void updatePreview();
...
private:
    ...
    QGroupBox*
        formatGroupBox;      ///< Container for export format selection controls
